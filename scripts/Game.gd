...
var levels = [preload("res://scenes/level_1.tscn"), preload("res://scenes/shop.tscn"), preload("res://scenes/level_2.tscn"), preload("res://scenes/shop.tscn"), preload("res://scenes/level_3.tscn")]
